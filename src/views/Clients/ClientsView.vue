<template>
    <div class="page">
        ...
        <Dialog
            ...
            :header="editingClient ? 'Editar Cliente' : 'Novo Cliente'"
            modal
            :style="{ width: '480px' }"
            @hide="resetForm"
        >
...
const confirmDelete = (client) => {
    confirm.require({
        message:     `Deseja remover o cliente "${client.name}"?`,
        ...
        accept: async () => {
            try {
                ...
                toast.add({ severity: 'success', summary: 'Removido', detail: 'Cliente removido.', life: 3000 })
                fetchClients()
            } catch {
